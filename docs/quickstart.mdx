...
<Info>
**Requirements:** Swift 4.2+, Xcode 10.3+, iOS 10+ minimum deployment target. Set in your Podfile: `platform :ios, '10.0'`
</Info>
...
3. **Configure AppDelegate.swift** (with frequency control):
```swift
import workmanager_apple
...
For comprehensive debugging guidance including platform-specific tools, ADB commands, and Xcode debugging, see the **[Debugging Guide](debugging)**.
